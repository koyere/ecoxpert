...
public enum BankAccountTier {
    ...
    public BigDecimal getDailyInterestRate() {
        return annualInterestRate.divide(new BigDecimal("365"), 10, RoundingMode.HALF_UP);
    }
    ...
    public BigDecimal getDailyLimit(BankTransactionType type) {
        ...
        return switch (type) {
            case DEPOSIT ->
                override != null && override.depositLimit() != null ? override.depositLimit() : dailyDepositLimit;
            case WITHDRAW ->
                override != null && override.withdrawLimit() != null ? override.withdrawLimit() : dailyWithdrawLimit;
            case TRANSFER_OUT ->
                override != null && override.transferLimit() != null ? override.transferLimit() : dailyTransferLimit;
