...
public class BankStatistics {
    ...
    public int getSystemHealthScore() {
        ...
        if (totalBalance.compareTo(BigDecimal.ZERO) > 0) {
            BigDecimal concentration = largestBalance.divide(totalBalance, 4, BigDecimal.ROUND_HALF_UP);
    ...
    public int getBasicAccounts() { return basicAccounts; }
    public int getSilverAccounts() { return silverAccounts; }
    public int getGoldAccounts() { return goldAccounts; }
    public int getPlatinumAccounts() { return platinumAccounts; }
    
    public BigDecimal getAverageBalance() { return averageBalance; }
    public BigDecimal getLargestBalance() { return largestBalance; }
    public BigDecimal getSmallestBalance() { return smallestBalance; }
    ...
    public static class TierDistribution {
        ...
        public double getSilverPercentage() { return silverPercentage; }
        public double getGoldPercentage() { return goldPercentage; }
        public double getPlatinumPercentage() { return platinumPercentage; }
    }
}