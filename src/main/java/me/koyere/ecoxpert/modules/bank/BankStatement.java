...
public class BankStatement {
    ...
    private BigDecimal calculateEffectiveYield() {
        ...
        BigDecimal yield = totalInterest.divide(averageBalance, 6, BigDecimal.ROUND_HALF_UP);
    ...
    public ActivityLevel getActivityLevel() {
        if (totalTransactions == 0) return ActivityLevel.INACTIVE;
        if (totalTransactions <= 5) return ActivityLevel.LOW;
        if (totalTransactions <= 20) return ActivityLevel.MODERATE;
        if (totalTransactions <= 50) return ActivityLevel.HIGH;
    ...
    public BigDecimal getAverageTransactionAmount() {
        ...
        return totalVolume.divide(new BigDecimal(totalTransactions), 2, BigDecimal.ROUND_HALF_UP);
    }
    ...
    public static class Builder {
        ...
        public Builder setAccountId(UUID accountId) { this.accountId = accountId; return this; }
        public Builder setYear(int year) { this.year = year; return this; }
        public Builder setMonth(Month month) { this.month = month; return this; }
        public Builder setAccountNumber(String accountNumber) { this.accountNumber = accountNumber; return this; }
        public Builder setAccountTier(BankAccountTier accountTier) { this.accountTier = accountTier; return this; }
        
        public Builder setOpeningBalance(BigDecimal openingBalance) { this.openingBalance = openingBalance; return this; }
        public Builder setClosingBalance(BigDecimal closingBalance) { this.closingBalance = closingBalance; return this; }
        public Builder setAverageBalance(BigDecimal averageBalance) { this.averageBalance = averageBalance; return this; }
        public Builder setMinimumBalance(BigDecimal minimumBalance) { this.minimumBalance = minimumBalance; return this; }
        public Builder setMaximumBalance(BigDecimal maximumBalance) { this.maximumBalance = maximumBalance; return this; }
        
        public Builder setTotalTransactions(int totalTransactions) { this.totalTransactions = totalTransactions; return this; }
        public Builder setTotalDeposits(BigDecimal totalDeposits) { this.totalDeposits = totalDeposits; return this; }
        public Builder setTotalWithdrawals(BigDecimal totalWithdrawals) { this.totalWithdrawals = totalWithdrawals; return this; }
        public Builder setTotalTransfersIn(BigDecimal totalTransfersIn) { this.totalTransfersIn = totalTransfersIn; return this; }
        public Builder setTotalTransfersOut(BigDecimal totalTransfersOut) { this.totalTransfersOut = totalTransfersOut; return this; }
        public Builder setTotalInterest(BigDecimal totalInterest) { this.totalInterest = totalInterest; return this; }
        public Builder setTotalFees(BigDecimal totalFees) { this.totalFees = totalFees; return this; }
        
        public Builder setDepositCount(int depositCount) { this.depositCount = depositCount; return this; }
        public Builder setWithdrawalCount(int withdrawalCount) { this.withdrawalCount = withdrawalCount; return this; }
        public Builder setTransferInCount(int transferInCount) { this.transferInCount = transferInCount; return this; }
        public Builder setTransferOutCount(int transferOutCount) { this.transferOutCount = transferOutCount; return this; }
        public Builder setInterestPayments(int interestPayments) { this.interestPayments = interestPayments; return this; }
        public Builder setFeeCharges(int feeCharges) { this.feeCharges = feeCharges; return this; }
        
        public Builder setInterestRate(BigDecimal interestRate) { this.interestRate = interestRate; return this; }
        public Builder setDaysActive(int daysActive) { this.daysActive = daysActive; return this; }
        public Builder setTransactions(List<BankTransaction> transactions) { this.transactions = transactions; return this; }
        ...
        public BankStatement build() {
            ...
            if (accountTier == null) throw new IllegalArgumentException("Account tier is required");
    ...
    public BankAccountTier getAccountTier() { return accountTier; }
    ...
    public int getInterestPayments() { return interestPayments; }
    public int getFeeCharges() { return feeCharges; }
    
    public BigDecimal getInterestRate() { return interestRate; }
    public BigDecimal getEffectiveYield() { return effectiveYield; }
