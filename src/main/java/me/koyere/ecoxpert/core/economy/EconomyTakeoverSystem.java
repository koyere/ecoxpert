...
public class EconomyTakeoverSystem {
    ...
    public SystemStatus getStatus() {
        ...
        try {
            EconomyConflictDetector.EconomyProviderStatus providerStatus = conflictDetector.detectEconomyProvider();

            EconomyConflictDetector.InstalledEconomyPlugins installedPlugins = conflictDetector
                    .detectInstalledEconomyPlugins();

            EconomySyncManager.SyncStatistics syncStats = syncManager != null ? syncManager.getStatistics() : null;
