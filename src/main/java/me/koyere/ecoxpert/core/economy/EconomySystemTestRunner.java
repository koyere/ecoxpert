...
public class EconomySystemTestRunner {
    ...
    private TestResult testModeManagerInitialization() {
        try {
            ...
            var vaultProvider = plugin.getServiceRegistry()
                    .getInstance(me.koyere.ecoxpert.economy.VaultEconomyProvider.class);
    ...
    private TestResult testVaultProviderSafety() {
        try {
            ...
            me.koyere.ecoxpert.economy.VaultEconomyProviderImpl impl = (me.koyere.ecoxpert.economy.VaultEconomyProviderImpl) vaultProvider;
